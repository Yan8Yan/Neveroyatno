...
namespace Neveroyatno.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            {
                new SelectListItem { Value = "Преподаватель", Text = "Преподаватель" },
                new SelectListItem { Value = "Студент", Text = "Студент" }
            };
        }
        ...
        private ApplicationUser CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Невозможно создать экземпляр '{nameof(ApplicationUser)}'. Убедитесь, что он не абстрактный и имеет конструктор без параметров.");
            }
        }
